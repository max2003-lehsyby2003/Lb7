...
public class Main {
    ...
    private void run() {
        ...
        while (true) {
            ...
            System.out.println("7. сохранение в Json файл");
            System.out.println("8. читання з Json файлу");
            System.out.println("9. Вихід з програми");
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    file = sc.next();
                    students = logik.createList();
                    json.writeToFileJson(file, students);
                    break;
                ...
                case 8:
                    ...
                    System.out.println("введіть назву файлу");
                    file = sc.next();
                    students = json.readFromFileJson(file);
                    System.out.println(students);
                    //System.out.println(json.readFromFileJson(file));
                    break;
